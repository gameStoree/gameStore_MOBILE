        ...
        children: <Widget>[
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => KT_Honkai()),
              );
            },
            child: Container(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      padding: EdgeInsets.only(
                          left: 10,
                          right: 15), // Tambahkan padding kiri di sini
                      decoration: BoxDecoration(
                        color: Color(0xff22577A),
                        borderRadius: BorderRadius.circular(5),
                        border: Border.all(color: Colors.white),
                        ...
                        children: [
                          Expanded(
                            child: DropdownButton(
                              isExpanded:
                                  true, // Membuat dropdown memenuhi lebar yang tersedia
