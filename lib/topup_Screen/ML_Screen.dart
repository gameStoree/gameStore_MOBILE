    ...
    if (_selectedDiamond != -1) {
      _diamondsFuture.then((diamondList) {
        Diamond selectedDiamond =
            diamondList.firstWhere((diamond) => diamond.id == _selectedDiamond);
        setState(() {
      ...
      if (response.statusCode == 201) {
        ...
        if (latestOrderResponse.statusCode == 200) {
          ...
          Navigator.of(context).push(
            MaterialPageRoute(
              builder: (context) =>
                  OrderDiamondPage(orderData: latestOrderData),
            ),
          );
        } else {
          print(
              'Failed to fetch latest order data: ${latestOrderResponse.statusCode}');
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
          ...
          return AlertDialog(
            ...
            content: Column(
              ...
              children: [
                ...
                Text("Item ID:  $_selectedDiamond",
                    style: TextStyle(fontSize: 16, color: Colors.white)),
                Text("Total Harga: Rp $totalHarga",
                    style: TextStyle(fontSize: 16, color: Colors.white)),
                Text("Phone Number: ${noHp.text}",
                    style: TextStyle(fontSize: 16, color: Colors.white)),
                Text("Product: Mobile Legend Diamond",
                    style: TextStyle(fontSize: 16, color: Colors.white)),
                Divider(color: const Color.fromARGB(255, 255, 255, 255)),
              ],
            ),
                    ...
                    children: [
                      ...
                      Container(
                        margin: EdgeInsets.only(
                            bottom: 8, top: 15, left: 15, right: 15),
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: _selectedDiamond == diamond.id
                                        ? Colors.blue
                                        : Color(0xff22577A),
                                    borderRadius: BorderRadius.circular(10),
                                  ),
